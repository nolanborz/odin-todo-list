export default class DOMManager {
  constructor(todoController) {
    ...
    this.standaloneTaskBtn = document.querySelector(
      ".standalone-task-form button",
    );
    this.standaloneTaskContainer = document.querySelector(
  ...
  initializeEventListeners() {
    ...
    this.standaloneTaskBtn.addEventListener("click", () => {
      ...
      const existingForm =
        this.standaloneTaskContainer.querySelector(".task-form");
    ...
    this.projectsContainer.addEventListener("click", (e) => {
      if (e.target.classList.contains("add-task-btn")) {
        ...
        const projectIndex = Array.from(
          this.projectsContainer.children,
        ).indexOf(projectElement);

        const taskFormContainer = projectElement.querySelector(
          ".task-form-container",
        );
  ...
  createTaskForm(projectIndex = null) {
    ...
    taskForm.addEventListener("submit", (e) => {
      ...
      if (projectIndex !== null) {
        ...
        const newTask = this.todoController.createTodo(
          title,
          description,
          dueDate,
          priority,
        ...
        console.log("New standalone task:", {
          title,
          description,
          dueDate,
          priority,
  ...
  renderStandaloneTasks() {
    ...
    const existingContainer =
      this.standaloneTaskContainer.querySelector(".standalone-tasks");
